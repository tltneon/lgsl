...
//------------------------------------------------------------------------------------------------------------+
  ...
  $lgsl_config['text']['lgn'] = "Connexion";
  $lgsl_config['text']['skc'] = "Enregistrer - Conserver le cache";
  $lgsl_config['text']['srh'] = "Enregistrer - Réinitialiser le cache";
  $lgsl_config['text']['mip'] = "Chemins d'image de carte";
  $lgsl_config['text']['avm'] = "Gestion avancée";
  $lgsl_config['text']['nrm'] = "Gestion normale";
  $lgsl_config['text']['bak'] = "RETOUR À LA LISTE DES SERVEURS";
  $lgsl_config['text']['yes'] = "OUI";
  $lgsl_config['text']['nno'] = "NO";
  $lgsl_config['text']['enb'] = "Activé";
