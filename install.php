	...
	function l(key){
		let t = {
			...
			"slovak": {
				...
				"after": "Potom čo vyvoríš konfiguraciu, vymeň subor za lgsl_files/lgsl_config.php",
				"selst": "Zvoliť štýl",
				"sella": "Zvoliť Jazyk",
				"sorts": "Zoradiť servery podla",
				"sortp": "Zoradiť hráčov podla",
				"enaim": "Povoliť obrazkové zobrazovanie",
				"hideo": "Nezobrazovať neaktývne servery.",
				"pubad": "Povoliť verejné pridavanie serverov",
				"showt": "Zobraziť celkové údaje",
				"showl": "Zobraziť lokality",
				"step1": "Krok 1: Inštalovať LGSL Tabulky",
